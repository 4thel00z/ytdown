...
* **build:** select the TLS backend via cargo features, vendor OpenSSL for wheels ([ec89272](https://github.com/4thel00z/ytdown/commit/ec892720b5f5a1ef3908bd6e2eb024a5ef4477a8))
